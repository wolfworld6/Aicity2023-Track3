...
if __name__ == "__main__":
    ...
    parser.add_argument('--data2_path', metavar='path', required=True,
    ...
    dir_path2 = args.data2_path
    json_output = args.json_output


    # dir_path = "/mnt/home/dataset/AIcity2023-track3/A1"
    # dir_path1 = "/mnt/home/dataset/AIcity2023-track3/A1_labels"
    # dir_path2 = "/mnt/home/dataset/AIcity2023-track3/A2"
    # json_output = "track3_only_Rearview_A1-train_A2-val-nullAnno.json"
    ...
    for i in os.listdir(dir_path2):
        ...
        for j in os.listdir(users_dir):
            if j.split("_")[0]=="Rear":  
                ...
                items_tmp={
                    "annotations":[],
                    "resolution":str(frame_w)+"*"+str(frame_h),
                    "duration":video_time,
                    "subset": "validation"
                }
                shell["database"][j[0:-4]]=items_tmp
